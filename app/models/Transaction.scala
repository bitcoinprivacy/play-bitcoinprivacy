...
case class Transaction(hash:String,value: Long) extends AddressData
case class Movement(address:String,mode: String, hash: String, value: Long) extends AddressData
case class Output(hash :String, spent: String ,value: Long) extends AddressData
